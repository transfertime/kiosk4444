      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input
            inputMode="numeric"
            placeholder="YYYY"
            className={`w-full rounded-md px-3 py-2 text-sm border ${fieldClass(expYear ? expValid : undefined)}`}
            value={expYear}
        ...
        <div>
          ...
          <input
            inputMode="numeric"
            maxLength={4}
            className={`w-full rounded-md px-3 py-2 text-sm border ${fieldClass(cvv ? cvvValid : undefined)}`}
            value={cvv}
