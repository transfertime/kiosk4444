    ...
    <section className="min-h-[calc(100vh-0px)] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {mode === "video" ? (
          ...
          <div className="w-full h-full">
            <img src={slides[idx]} className="w-full h-full object-cover" alt="slide" />
          </div>
        )}
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-24">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="ml-4">
            <button
              onClick={() => setMode((m) => (m === "video" ? "slider" : "video"))}
        ...
        <p className="mt-4 text-slate-600 max-w-2xl">
          Bu sayfa talebiniz doğrultusunda özelleştirilebilir. Devam etmek için bize ne görmek istediğinizi söyleyin.
        </p>
        <div className="mt-8">
          <Link to="/" className="rounded-md bg-brand text-white px-5 py-3 font-semibold">
            Ana sayfaya dön
          </Link>
        </div>
      </div>
